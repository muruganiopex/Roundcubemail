...
$config['password_ldap_basedn'] = "o=domains,dc=example,dc=com";
...
$config['password_ldap_userDN_mask'] = "mail=%login,ou=Users,domainName=%domain,o=domains,dc=example,dc=com";
